...
export type ChannelFilters = QueryFilters<ContainsOperator<Omit<CustomChannelData, 'name'>> & {
    ...
    pinned?: boolean;
    last_updated?: RequireOnlyOne<Pick<QueryFilter<string>, '$eq' | '$gt' | '$gte' | '$lt' | '$lte'>> | PrimitiveFilter<string>;
} & {
...
export type MessageFilters = QueryFilters<ContainsOperator<CustomMessageData> & {
    ...
    [Key in keyof Omit<MessageResponse, 'text' | keyof CustomMessageData>]?: RequireOnlyOne<QueryFilter<MessageResponse[Key]>> | PrimitiveFilter<MessageResponse[Key]>;
}>;
...
export type UserFilters = QueryFilters<ContainsOperator<CustomUserData> & {
    id?: RequireOnlyOne<{
        $autocomplete?: UserResponse['id'];
    } & QueryFilter<UserResponse['id']>> | PrimitiveFilter<UserResponse['id']>;
    name?: RequireOnlyOne<{
        $autocomplete?: UserResponse['name'];
    } & QueryFilter<UserResponse['name']>> | PrimitiveFilter<UserResponse['name']>;
    ...
    username?: RequireOnlyOne<{
        $autocomplete?: UserResponse['username'];
    } & QueryFilter<UserResponse['username']>> | PrimitiveFilter<UserResponse['username']>;
} & {
...
export type MemberFilters = QueryFilters<{
    ...
    invite?: {
        $eq?: ChannelMemberResponse['status'];
    } | ChannelMemberResponse['status'];
    is_moderator?: RequireOnlyOne<{
        $eq?: ChannelMemberResponse['is_moderator'];
    ...
    notifications_muted?: RequireOnlyOne<{
        $eq?: ChannelMemberResponse['notifications_muted'];
    ...
    [Key in keyof ContainsOperator<CustomMemberData>]?: RequireOnlyOne<QueryFilter<ContainsOperator<CustomMemberData>[Key]>> | PrimitiveFilter<ContainsOperator<CustomMemberData>[Key]>;
}>;
/**
 * Sort Types
 */
...
export type MemberSort = Sort<Pick<UserResponse, 'created_at' | 'last_active' | 'name' | 'updated_at'> & {
    user_id?: string;
}> | Array<Sort<Pick<UserResponse, 'created_at' | 'last_active' | 'name' | 'updated_at'> & {
    user_id?: string;
}>>;
...
export type ChannelData = CustomChannelData & Partial<{
    blocked: boolean;
    created_by: UserResponse | null;
    created_by_id: UserResponse['id'];
...
export type CommandVariants = 'all' | 'ban' | 'fun_set' | 'giphy' | 'moderation_set' | 'mute' | 'unban' | 'unmute' | keyof CustomCommandData;
...
export type MessageUpdatableFields = Omit<MessageResponse, 'cid' | 'created_at' | 'updated_at' | 'deleted_at' | 'user' | 'user_id'>;
...
export declare class ErrorFromResponse<T> extends Error {
    ...
    name: string;
    constructor(message: string, { code, status, response, }: {
...
export type PollResponse = CustomPollData & PollEnrichData & {
    created_at: string;
    created_by: UserResponse | null;
    created_by_id: string;
...
export type PollEnrichData = {
    ...
    latest_answers: PollAnswer[];
    latest_votes_by_option: Record<string, PollVote[]>;
    vote_count: number;
    vote_counts_by_option: Record<string, number>;
    own_votes?: (PollVote | PollAnswer)[];
};
...
export type ReminderFilters = QueryFilters<{
    ...
    remind_at?: RequireOnlyOne<Pick<QueryFilter<ReminderResponseBase['remind_at']>, '$exists' | '$eq' | '$gt' | '$lt' | '$gte' | '$lte'>> | PrimitiveFilter<ReminderResponseBase['remind_at']>;
